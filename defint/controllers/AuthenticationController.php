...
class AuthenticationController
{
    ...
    public function admin()
    {
       ...
       $checkAdmin="SELECT id, role_as FROM managers WHERE id='$manager_id' AND role_as='1' LIMIT 1";
    ...
    $result=$this->conn->query($getUserData);
     if($result->num_rows > 0){
       ...
       return $data;
        ...
        redirect("<h4>Something Went wong </h4>","login.php");
     }
    }else{
        return false;
    }
...
redirect("<h4 style='color:red;' >Login to Access the page</h4>","login.php");
   return false;
  } else{ 
return true;
  }
