    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">DEFINT</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="ad_settings.php"><i class="fa fa-globe fa-spin fa-3x fa-fw"></i> Settings</a>
                    </li>
                    <!--   <li>
                   ...
                   <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="ad_settings.php">Settings</a>
                            </li>
                            <li>
                           ...
                           <li>
                                <a href="ad_profile.php">Profile<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="ad_profile.php">Profile</a>
                                    </li>
                                    <li>
                                        <a href="ad_updateProfile.php">Update Profile</a>
                                    </li>
                                    <li>
                                        <a href="ad_changePassword.php">Change Password</a>
                                    </li>
            ...
            <?php
                ...
                ?>
            <p style="color:white; text-align:center;"><a href="ad_viewProfile.php">Admin Profile Image</a></p>
            </div>
        </nav>  