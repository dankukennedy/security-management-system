                    ...
                    <div class="col-md-12">
                       ...
                       <h3><strong>Defence Intellengence DSR </strong></h3>
                        <section class="mail-list">
                                        ...
                                        <?php
                                       $email=$data['email']; 
                                        $task_Qry="SELECT * FROM tasks WHERE email='$email' ORDER BY id DESC  LIMIT 10 ";
                                        $result=$db->conn->query($task_Qry);
                                        if(!$result)
                                        {
 ...
 <!-- Collapsable Card Example -->
                            <div class="card shadow mb-4">
                                ...
                                <a href="#" class="d-block card-header py-3" data-toggle="collapse"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Subject:<br>'.$row['email'] .' </h6>
                                </a>
